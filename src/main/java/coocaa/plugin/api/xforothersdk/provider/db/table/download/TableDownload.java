package org.apache.cordova.plugin.api.xforothersdk.provider.db.table.download;
...
import org.apache.cordova.plugin.api.xforothersdk.framework.pm.XPackageManager;
import org.apache.cordova.plugin.api.xforothersdk.framework.utils.MD5;
import org.apache.cordova.plugin.api.xforothersdk.provider.ProviderData;
import org.apache.cordova.plugin.api.xforothersdk.provider.db.Table;
...
public class TableDownload extends Table {
    ...
    public SuperXFinder.XIntent getCompleteAction() {
        try {
            return SuperXFinder.XIntent.parseJObject(completeaction, SuperXFinder.XIntent.class);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
...
//    public static final int STATUS_ON_STARTING = DOWNLOAD_STATUS.ON_STARTING.ordinal();
    ...
    public static TableDownload _createAppDownload(String url, String md5, String title, String packageName, String appID, String iconUrl) {
        ...
        if (download == null) {
            ...
            SuperXFinder.XIntent action = null;
            try {
