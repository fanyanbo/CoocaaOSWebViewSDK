...
import coocaa.plugin.api.pay.ccapi.paydata.ApiDefData;
import coocaa.plugin.api.pay.ccapi.paydata.DefData;
import coocaa.plugin.api.pay.ccapi.paydata.OrderData;
import coocaa.plugin.api.pay.ccapi.paydata.OrderState;
import coocaa.plugin.api.pay.ccapi.paydata.PayBackData;
import coocaa.plugin.api.pay.ccapi.paydata.UserInfo;
import coocaa.plugin.api.pay.sky.api.utils.HttpResult;
import coocaa.plugin.api.pay.sky.api.utils.HttpUtilSimple;
import coocaa.plugin.api.pay.sky.api.utils.SimpleCrypto;
import coocaa.plugin.api.pay.sky.api.wblogin.CfgFile;
