...
//    protected ImageView mErrorPageImageView = null;
	...
	protected int cacheMode = 1;//0:no-cache,1:default,2:cache_only,3:cache_else_network
	...
	public CordovaExtWebView(Context context) {
		...
		Log.i(TAG,"CordovaExtWebView constructor WebviewSDK version = " + org.apache.cordova.plugin.api.version.SystemWebViewSDK.getVersionName() + ",mMachineName = " + mMachineName);
