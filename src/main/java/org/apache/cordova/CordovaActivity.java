...
public class CordovaActivity extends CordovaBaseActivity {
        ...
        cordovaInterface.setCordovaInterfaceListener(new CordovaInterfaceImpl.CordovaInterfaceListener() {
            ...
            public void onPageStarted(String url) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        if(mLoadingView != null) mLoadingView.showLoading();
            ...
            public void onPageLoadingFinished(String url) {
                ...
                appView.getView().setVisibility(View.VISIBLE);
                if(mLoadingView != null) mLoadingView.dismissLoading();
            }
    ...
    protected void createViews() {
        ...
        mMainLayout.addView(appView.getView());
        ...
        mMainLayout.addView(mLoadingView, loading_p);
