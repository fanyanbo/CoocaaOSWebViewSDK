...
public class CordovaActivity extends CordovaBaseActivity{
    ...
    protected LinearLayout mErrorView = null;
    ...
    protected boolean mIsBeginLoad = true;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(TAG,"CordovaActivity onCreate ro.product.name = " + mMachineName);
        ...
        cordovaInterface.setCordovaInterfaceListener(new CordovaInterfaceListener() {
			...
			public void onReceivedError(int errorCode, String description,
				...
				if(mMachineName.contains("14U") && errorCode == -6)
				{
					mIsBeginLoad = true;
				}
				if(errorCode == -2)
	...
	protected void showErrorPage(boolean isdisconnect) {
		
		boolean isInit = initErrorPage(isdisconnect);
		if(isInit)
		{
	...
	protected boolean initErrorPage(boolean isdisconnect) {
		...
		if (mErrorView == null) {
	        ...
	        mErrorView.addView(mErrorBgLayout);
			...
			imgViewLp.topMargin = SkyScreenParams.getInstence(this).getResolutionValue(300);
			...
			txtViewLp.topMargin = SkyScreenParams.getInstence(this).getResolutionValue(555);
	
			mBtnView = new Button(this);
			mBtnView.setFocusable(true);
			mBtnView.setFocusableInTouchMode(true);
			mBtnView.setTextSize(SkyScreenParams.getInstence(this).getTextDpiValue(36));
			mBtnView.setTextColor(getResources().getColor(android.R.color.black));
			...
			FrameLayout.LayoutParams btnViewLp = new FrameLayout.LayoutParams(
					SkyScreenParams.getInstence(this).getResolutionValue(400), SkyScreenParams.getInstence(this).getResolutionValue(250));
			btnViewLp.gravity = Gravity.CENTER_HORIZONTAL;
			btnViewLp.topMargin = SkyScreenParams.getInstence(this).getResolutionValue(580);
			
			mErrorBgLayout.addView(mImageView,imgViewLp);
			mErrorBgLayout.addView(mTextView,txtViewLp);	
			mErrorBgLayout.addView(mBtnView,btnViewLp);
		...
		if(isdisconnect)
		{
			...
			mImageView.setImageResource(R.drawable.net_disconnect);
		...
		else 
		{
			...
			mImageView.setImageResource(R.drawable.net_refresh);
    ...
    OnClickListener clickListener = new OnClickListener()
    {
        ...
        {
        	Log.i(TAG,"CordovaActivity onClick tag = " + v.getTag());
