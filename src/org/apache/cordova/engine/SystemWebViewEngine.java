...
public class SystemWebViewEngine implements CordovaWebViewEngine {
    ...
    private void initWebViewSettings() {
        ...
        if(android.os.Build.VERSION.SDK_INT >= 21/*android.os.Build.VERSION_CODES.LOLLIPOP*/)
        {
        	...
        	SysWebviewCompatLayer.webSettingSetMixedContentMode(settings, 0 /*WebSettings.MIXED_CONTENT_ALWAYS_ALLOW*/ );
        }
    ...
    private void enableRemoteDebugging() {
        try {
        	...
        	SysWebviewCompatLayer.webViewSetWebContentsDebuggingEnabled(true);
        } catch (IllegalArgumentException e) {
