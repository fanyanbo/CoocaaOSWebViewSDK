...
class CoreAndroid extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        try {
            ...
            else if (action.equals("overrideHomebutton")) { //add by fyb
                this.overrideHomebutton(args.getBoolean(0));
            }
    ...
    //add by fyb
    public void overrideHomebutton(boolean override) {
    	LOG.i("App", "WARNING: Home Button Default Behavior will be overridden.  The homebutton event will be fired!");
        webView.setButtonPlumbedToJs(KeyEvent.KEYCODE_HOME, override);
    }
